...
<main class="flow ">
    <section>
        <div class="container">
            ...
            <form method="POST" id="reset-form" class="needs-validation" action="<?php echo base_url('login/forgotPassword');?>">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 col-sm-12 form-group">
                        ...
                        <input name="email" id="email" class="form-control form-control-lg" required />
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 col-sm-12 form-group">
                        <input type="submit" value="Send Login Link" class="btn btn-lg btn-primary btn-block" />
                    </div>
                </div>
