										...
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<input type="text" id="first_name" name="first_name" value="<?= $first_name ?>" placeholder="Enter  First name" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="last_name" class=" form-control-label">Last Name</label>
													<input type="text" id="last_name" name="last_name" value="<?= $last_name ?>" placeholder="Enter  Last name" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
											...
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<input type="text" id="Address" name="address" value="<?= $address ?>" placeholder="Enter Address" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="Apt" class=" form-control-label">Apt</label>
													<input type="text" id="Apt" name="apt" value="<?= $apt ?>" placeholder="Enter apt" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="City" class=" form-control-label">City</label>
													<input type="text" id="City" name="city" value="<?= $city ?>" placeholder="Enter City" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
											...
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<input type="text" id="zip" name="zip" value="<?= $zip ?>" placeholder="Enter zip" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="Dob" class=" form-control-label">Dob</label>
													<input type="text" id="dob" name="dob" value="<?= date('d-m-Y', $dob); ?>" placeholder="Enter zip" class="form-control">
												</div>
											</div>
