            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="overview-wrap mr-3">
                        <a class="btn btn-success pull-right" href="<?php echo base_url('settlement/admin/add');?>">Add New+</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo ucfirst($result['creditor'])?></td>
                                        <td><?php echo '$'.$result['debt_amount']?></td>
                                        <td><?php echo '$'.$result['settlement']?></td>
                                        <td><?php echo $result['savings'].'%'?></td>
                                        <td>
                                            <div class="td-actions">
                                                <button class="btn btn-success edit nw_clicks" rel="tooltip" data-toggle="tooltip" pid="<?php echo $result['id'] ?>" data-placement="top" title="" data-original-title="Edit">
                                                    <a href="<?php echo base_url($module.'/admin/edit/'.$result['id']); ?>" style="color: white;"><i class="material-icons">edit</i></a>
                                                </button>
