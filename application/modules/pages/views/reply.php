                            ...
                            <div class="card">
                                <div class="fluttr_tbs_text">
                                    <div class="chat_box">
                                        ...
                                        <?php else : ?>
                                            <div class="chats scrollbar">
                                                <div class="not_found text-center">NO replies yet</div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($status == 0) : ?>
                                            <form>
                                            ...
                                            <?php if ($this->common_model->is_admin() && $status <> 1) : ?>
                                                <div class="rs-select2--trans rs-select2--sm">
                                                    <select lead_id="<?php echo $id ?>" class="js-select2" name="status">
                                                        <option <?php echo $disable; ?> value="0" <?php if ($status == 0) {
                                                                                                        echo "selected";
                                                                                                    }; ?>>Open</option>
                                                        <option <?php echo $disable; ?> value="2" <?php if ($status == 2) {
                                                                                                        echo "selected";
                                                                                                    }; ?>>Hold</option>
                                                        <option <?php echo $disable; ?> value="1" <?php if ($status == 1) {
                                                                                                        echo "selected";
                                                                                                    }; ?>>Close</option>
                                                    </select>
