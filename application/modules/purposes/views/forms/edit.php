		...
		<div class="container-fluid">
			...
			<div class="row row m-t-25">
					...
					<div class="col-lg-12">
						...
						<div class="card">
							<form action="<?php echo base_url($module.'/admin/edit/'.$id) ?>" method="POST">
									...
									<div class="row form-group">
										<div class="col-12">
											<div class="form-group">
												...
												<input type="text" id="title" name="title" value="<?=$title?>" placeholder="Enter title" class="form-control">
											</div>
										</div>
									</div>
								</div>
