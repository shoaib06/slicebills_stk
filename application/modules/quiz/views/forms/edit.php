								...
								<form action="<?php echo base_url($module . '/admin/edit/'.$id) ?>" method="POST" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="col-sm-10 col-xs-12">
												<label class="bmd-label-floating">Option <?= $count; ?></label>
												<div class="form-group">
													<textarea name="answers[<?php echo $answer_id; ?>]" rows="8" class="form-control  " id="answer1"><?=
													$answer['answer'];
													?></textarea>
												</div>
											</div>
											<div class="col-sm-2 col-xs-12">
												<div class="form-group">
													...
													<input type="radio" value="<?= $count; ?>" name="correct" <?= $answer['is_correct']==1?'checked':0; ?>>
												</div>
											</div>
											<?php $count++;?>	
											<?php endforeach;?>	
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<input type="radio" value="1"  name="status" <?= $status==1?'checked':''; ?>> Active
