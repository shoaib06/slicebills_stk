								...
								<tbody>
									<?php if ($results) : ?>
										<?php foreach ($results as $result) : ?>
											...
											<tr>
												<td><?php echo ucfirst($result['question']); ?></td>
												<td>
												...
												<td>
													<div class="td-actions">
														...
														<a href="<?php echo base_url($module . '/admin/delete/' . $result['id']); ?>" onclick="return confirm('Are you sure you want to delete this?');">
