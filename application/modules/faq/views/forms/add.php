									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group bmd-form-group">
												...
												<input type="text" name="title" class="form-control" name="settlement">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group bmd-form-group">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group bmd-form-group">
												...
												<textarea  id="trumbowyg-demo" name="description"  class="form-control" rows="5" placeholder="Answer"></textarea>
											</div>
										</div>
									</div>
