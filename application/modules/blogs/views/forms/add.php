                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="date" value="" name="blog_date" />
                                                </div>
                                            </div>
                                            <!-- <div class="col-md-12">
                                                <div class="form-group bmd-form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <select name="category" id="" class="form-control">
                                                        ...
                                                        <option value="2">Top Reads</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group bmd-form-group">
                                                    ...
                                                    <textarea id="trumbowyg-demo" name="description" class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                        </div>
