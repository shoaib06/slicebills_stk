										...
										<div class="row">
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													...
													<input type="text" id="name" name="name" value="<?= set_value('name') ?>" placeholder="Enter name" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="email" class=" form-control-label">E-mail</label>
													<input type="email" id="email" name="email" value="<?= set_value('email') ?>" placeholder="Enter Email" class="form-control">
												</div>
											</div>
											<div class="col-sm-6 col-xs-12">
												<div class="form-group">
													<label for="phone" class=" form-control-label">Phone</label>
													<input type="text" id="phone" name="phone" value="<?= set_value('phone') ?>" placeholder="Enter Phone" class="form-control">
												</div>
											</div>
										</div>
